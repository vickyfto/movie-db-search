...
class Widget03 extends Component<any, any> {
  static propTypes: { children: PropTypes.Requireable<PropTypes.ReactNodeLike>; className: PropTypes.Requireable<string>; cssModule: PropTypes.Requireable<object>; dataBox: PropTypes.Requireable<(...args: any[]) => any>; };
  static defaultProps: { dataBox: () => { variant: string; friends: string; feeds: string; }; };
